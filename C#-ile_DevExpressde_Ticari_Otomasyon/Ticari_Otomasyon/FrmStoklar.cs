...
namespace Ticari_Otomasyon
{
    public partial class FrmStoklar : Form
    {
        ...
        {
            //chartControl1.Series["Series 1"].Points.AddPoint("İstanbul", 17);
            //chartControl1.Series["Series 1"].Points.AddPoint("Ankara", 10);
            //chartControl1.Series["Series 1"].Points.AddPoint("Mersin", 13);
            //chartControl1.Series["Series 1"].Points.AddPoint("İzmir", 20);
            ...
            // Chart 2 şehirle göre firmaları getirme
